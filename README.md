...
*Self-taught developer · BSIT Graduate · BPO → Tech*

[![Portfolio](https://img.shields.io/badge/Portfolio-ransnotdev.vercel.app-7c7ff5?style=for-the-badge&logo=vercel&logoColor=white)](https://ransnotdev.vercel.app)
...
[![Email](https://img.shields.io/badge/Email-ranyboytemplado001@gmail.com-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:ranyboytemplado001@gmail.com)
...
My customer service background trained me to:
- Handle complex concerns efficiently under pressure
- Communicate clearly with both technical and non-technical people
- Adapt quickly — a skill that transfers directly to debugging and problem-solving in tech
...
```bash
RansnotDEV@portfolio:~$ stack --icons --modern
```
