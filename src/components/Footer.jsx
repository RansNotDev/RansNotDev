...
const socialLinks = [
  {
    name: 'GitHub',
    url: 'https://github.com/ranyboytemplado',
    icon: (
  ...
  {
    name: 'LinkedIn',
    url: 'https://linkedin.com/in/ranyboytemplado',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    name: 'Instagram',
    url: 'https://instagram.com/ranyboytemplado',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
      ...
      <div className="footer__container">
        ...
        <div className="footer__body">
          ...
          <div className="footer__cta">
            <p className="footer__cta-label">
              <span className="footer__prompt">&gt;</span> Let's build something together
            </p>
            <h2 className="footer__cta-heading">Open to Work</h2>
            <p className="footer__cta-sub">
              Available for full-time, freelance, or remote opportunities.
            </p>

            {/* Email — mailto + Hire Me hover */}
            <a
              href="mailto:ranyboytemplado001@gmail.com"
              className="footer__email-btn"
            >
              <span className="footer__email-default">
        ...
        <div className="footer__bottom">
          <p className="footer__copy">
            ...
            © 2026 Rany Boy Templado
          </p>
          <p className="footer__copy-right">
            <span className="footer__copy-comment">status: </span>
            <span className="footer__copy-green">open_to_work = true</span>
          </p>
        </div>
